...
class SingleTimeRunner(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_head_0_0_0 = blocks.head(gr.sizeof_char*1, (28*100))
        self.blocks_head_0_0 = blocks.head(gr.sizeof_gr_complex*1, (sps*28*100))
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, (sps*28*100))
