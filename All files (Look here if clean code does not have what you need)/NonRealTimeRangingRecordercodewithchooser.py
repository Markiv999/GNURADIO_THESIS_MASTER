...
class NonRealTimeRangingRecorder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.variable_qtgui_chooser_1 = variable_qtgui_chooser_1 = 435000000
        ##################################################
        # Blocks`
        ##################################################
        # Create the options list
        self._variable_qtgui_chooser_1_options = [145000000,145850000, 435000000 , 70000000, 436650000]
        # Create the labels list
        self._variable_qtgui_chooser_1_labels = ['145000000', '435000000', '70000000','436650000','145850000']
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.variable_qtgui_chooser_1, 0)
        ...
        print(np.float64(self.uhd_usrp_sink_0.get_time_last_pps().get_real_secs()))
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\RangingSignals\\187KLengthSignal\\Test29', False)
    ...
    def set_variable_qtgui_chooser_1(self, variable_qtgui_chooser_1):
        ...
        self._variable_qtgui_chooser_1_callback(self.variable_qtgui_chooser_1)
        self.uhd_usrp_sink_0.set_center_freq(self.variable_qtgui_chooser_1, 0)
        self.uhd_usrp_source_0.set_center_freq(self.variable_qtgui_chooser_1, 0)
