...
class NonRealTimeRangingRecorder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(variable_qtgui_chooser_1, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(variable_qtgui_chooser_1, 0)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\RangingSignals\\75KLengthSignal\\Switchtest16', False)
