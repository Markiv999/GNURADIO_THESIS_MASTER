...
class RemodderGnuradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RemodderGnuradio")
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\CorrelationwithDelfiBoard\\SentSignals', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\CorrelationwithDelfiBoard\\ReceivedremoddedSignals', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\CorrelationwithDelfiBoard\\SentInterpolatedSignals', False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.blocks_file_sink_0_0, 0))
...
def main(top_block_cls=RemodderGnuradio, options=None):
