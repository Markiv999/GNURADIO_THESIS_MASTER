...
class SingleTimeRunner(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Vectorsize = Vectorsize = 28*sps*50
        ...
        self.blocks_head_0_0_0 = blocks.head(gr.sizeof_char*1, (int(Vectorsize/sps)))
        self.blocks_head_0_0 = blocks.head(gr.sizeof_gr_complex*1, Vectorsize)
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, Vectorsize)
    ...
    def set_sps(self, sps):
        ...
        self.blocks_head_0_0_0.set_length((int(self.Vectorsize/self.sps)))
    ...
    def set_Vectorsize(self, Vectorsize):
        ...
        self.blocks_head_0.set_length(self.Vectorsize)
        self.blocks_head_0_0.set_length(self.Vectorsize)
        self.blocks_head_0_0_0.set_length((int(self.Vectorsize/self.sps)))
