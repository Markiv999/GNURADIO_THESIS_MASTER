...
class RemodderforBoardTests(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RemodderforBoardTests")
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\GNURADIO_THESIS_MASTER\\CorrelationwithDelfiBoard\\ReceivedSignalremodded', False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.digital_gmsk_demod_0_0, 0))
        ...
        self.connect((self.digital_gmsk_demod_0_0, 0), (self.digital_gfsk_mod_0, 0))
...
def main(top_block_cls=RemodderforBoardTests, options=None):
