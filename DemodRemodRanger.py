...
import DemodRemodRanger_epy_block_1_0_0_0 as epy_block_1_0_0_0  # embedded python block
import sip
import numpy as np


class DemodRemodRanger(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DemodRemodRanger")
        ...
        self.digital_gfsk_mod_0 = digital.gfsk_mod(
            ...
            log=False,
            do_unpack=True)
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0x0B ,0xF1 ,0xC4 ,0x1A ,0x17 ,0x17 ,0x3E ,0x51 ,0x2C ,0x93 ,0x0F ,0xD0 ,0x2C ,0x43 ,0x84 ,0xB0 ,0xDF ,0x04 ,0x4A ,0x99 ,0x26 ,0x0B ,0xDE ,0x92 ,0xAB ,0xC7 ,0x69 ,0x15), True, 1, [])
        ...
        self.connect((self.blocks_float_to_uchar_0, 0), (self.epy_block_1_0_0_0, 1))
        self.connect((self.blocks_float_to_uchar_0_0, 0), (self.epy_block_1_0_0_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_uchar_to_float_1_0, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_1_1, 0), (self.blocks_pack_k_bits_bb_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_1_1, 0), (self.blocks_uchar_to_float_0_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_1_1, 0), (self.blocks_uchar_to_float_1_0, 0))
        ...
        self.connect((self.digital_gmsk_demod_0, 0), (self.blocks_uchar_to_float_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.blocks_float_to_uchar_0_0, 0))
...
def main(top_block_cls=DemodRemodRanger, options=None):
