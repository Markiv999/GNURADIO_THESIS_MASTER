...
class SingleTimeRunner(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_skiphead_0_1 = blocks.skiphead(gr.sizeof_char*1, (int(samp_rate*5/sps)))
        ...
        self.blocks_head_0_0_0 = blocks.head(gr.sizeof_char*1, (28*10))
        self.blocks_head_0_0 = blocks.head(gr.sizeof_gr_complex*1, (sps*28*10))
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, (sps*28*10))
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_0, 0), (self.blocks_skiphead_0, 0))
        ...
        self.connect((self.blocks_skiphead_0_1, 0), (self.blocks_head_0_0_0, 0))
        ...
        self.connect((self.digital_gfsk_mod_0, 0), (self.blocks_skiphead_0_0, 0))
        self.connect((self.digital_gmsk_demod_0, 0), (self.blocks_skiphead_0_1, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.blocks_head_0.set_length((self.sps*28*100))
        self.blocks_head_0_0.set_length((self.sps*28*100))
